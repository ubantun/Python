...
class AMI_powersite_setting_008(unittest.TestCase):
    ...
    def testName1(self):
        self.driver.find_element_by_id('com.inhe.psite:id/clean_record').click()
        self.driver.find_element_by_id('com.inhe.psite:id/clean_cancel').click()
        element = self.driver.find_element_by_id('com.inhe.psite:id/user_name')
        if not element.is_displayed():
            print 'the cancle for the clean is error'
            
        self.driver.find_element_by_id('com.inhe.psite:id/clean_record').click()
        self.driver.find_element_by_id('com.inhe.psite:id/clean_positive').click()
        element = self.driver.find_element_by_id('com.inhe.psite:id/user_name')
        if not element.is_displayed():
            print 'the back for the clean is error'
