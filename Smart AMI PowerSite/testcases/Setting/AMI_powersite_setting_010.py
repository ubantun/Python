...
class AMI_powersite_setting_010(unittest.TestCase):
    ...
    def testName1(self):
        self.driver.find_element_by_id('com.inhe.psite:id/connect_set').click()
        self.driver.find_element_by_id('com.inhe.psite:id/ok').click()
